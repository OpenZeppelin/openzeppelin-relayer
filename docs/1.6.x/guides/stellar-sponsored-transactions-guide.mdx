...
For a complete example of how to create trustlines, see the [Relayer SDK example](https://github.com/OpenZeppelin/openzeppelin-relayer-sdk/blob/main/examples/relayers/stellar/src/sponsored/createTrustline.ts).
...
- [OpenZeppelin Relayer API Reference](/relayer/1.6.x/api)
