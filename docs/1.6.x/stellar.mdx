...
For detailed signer configuration, see the [Signers Configuration](/relayer/1.6.x/configuration/signers) guide.
...
* See [Project Roadmap](/relayer/1.6.x/roadmap) for upcoming features
