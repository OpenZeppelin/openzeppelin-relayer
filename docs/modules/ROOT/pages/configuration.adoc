...
**Storage Configuration:** How these approaches interact depends on your storage backend (in-memory vs Redis). See xref:storage.adoc[Storage Configuration] for detailed information about storage behavior and best practices.
...
[NOTE]
====
How configuration management interacts with storage depends on your storage type. For detailed information about storage behavior, configuration persistence, and best practices, see the xref:storage.adoc[Storage Configuration] guide.
====