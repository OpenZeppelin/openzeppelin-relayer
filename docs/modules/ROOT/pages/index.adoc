...
"custom_rpc_urls": [
  {
    "url": "https://primary-rpc.example.com",
    "weight": 2  // Higher weight means more requests are sent to this endpoint. Value must be an integer from 0 to 255.
  },
  {
    "url": "https://backup-rpc.example.com"  // No weight specified, defaults to 255
  }
]
----
...
* Configure appropriate weights to prioritize more reliable/performant endpoints. The weight must be an integer from 0 to 255.
* If weight is not specified, a default weight of 255 is used
====
