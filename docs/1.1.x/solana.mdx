...
For detailed network configuration options, see the [Network Configuration](/relayer/1.1.x/network_configuration) guide.
...
For a step-by-step setup, see [Quick Start Guide](/relayer/1.1.x/quickstart).
Key prerequisites:
...
You can check all options in [User Documentation - Relayers](/relayer/1.1.x#3-relayers).
...
The Solana API conforms to the [Paymaster spec](https://docs.google.com/document/d/1lweO5WH12QJaSAu5RG_wUistyk_nFeT6gy1CdvyCEHg/edit?tab=t.0#heading=h.4yldgprkuvav).
...
* See [Project Roadmap](/relayer/1.1.x/roadmap) for upcoming features
