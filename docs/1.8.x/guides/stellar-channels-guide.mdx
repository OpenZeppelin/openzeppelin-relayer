...
This policy allows generous usage for development and production while preventing abuse. If you have higher throughput requirements, consider [self-hosting the Channels plugin](/relayer/1.8.x/plugins/channels).
