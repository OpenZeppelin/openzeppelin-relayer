...
For detailed signer configuration options, see the [Signers](/relayer/1.8.x/configuration/signers) guide.
...
For a step-by-step setup, see [Quick Start Guide](/relayer/1.8.x/quickstart).
Key prerequisites:
