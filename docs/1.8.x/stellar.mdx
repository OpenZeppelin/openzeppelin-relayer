...
For detailed signer configuration, see the [Signers Configuration](/relayer/1.8.x/configuration/signers) guide.
...
* See [Project Roadmap](/relayer/1.8.x/roadmap) for upcoming features
