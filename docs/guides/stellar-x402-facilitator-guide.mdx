...
For high-throughput x402 payment settlement, you can connect the x402 Facilitator plugin with the [OpenZeppelin Stellar Channels Service](/relayer/guides/stellar-channels-guide). The Channels service provides managed infrastructure for parallel transaction submission on Stellar, handling fee management and sequence number coordination automatically.
...
For more details on the Channels service, see the [Stellar Channels Guide](/relayer/guides/stellar-channels-guide) and the [Channels Plugin documentation](/relayer/plugins/channels).
