...
For detailed network configuration options and examples, see the [Network Configuration](/relayer/1.0.x/network_configuration) page.

<Callout>


For information about our development plans and upcoming features, see [Project Roadmap](/relayer/1.0.x/roadmap).
...
To get started immediately, see [Quickstart](/relayer/1.0.x/quickstart).
...
For detailed information about each directory and its contents, see [Project Structure Details](/relayer/1.0.x/structure).
...
<Callout>
Before executing the command, ensure that the `.env` and `config.json` files are configured as detailed in the [Configuration References](#configuration_references) section.
</Callout>
...
See the dedicated [Configuration Guide](/relayer/1.0.x/configuration).
