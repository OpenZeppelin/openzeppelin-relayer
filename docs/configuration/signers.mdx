...
| --- | --- | --- | --- | --- |
| `local` | ✅ Supported | ✅ Supported | ✅ Supported | ✅ Supported |
| `vault` | ✅ Supported | ✅ Supported | ❌ Not supported | ❌ Not supported |
| `vault_transit` | ❌ Not supported | ✅ Supported | ❌ Not supported | ❌ Not supported |
| `turnkey` | ✅ Supported | ✅ Supported | ✅ Supported | ❌ Not supported |
| `google_cloud_kms` | ✅ Supported | ✅ Supported | ✅ Supported | ❌ Not supported |
| `aws_kms` | ✅ Supported | ❌ Not supported | ❌ Not supported | ❌ Not supported |
| `cdp` | ✅ Supported | ✅ Supported | ❌ Not supported | ❌ Not supported |
