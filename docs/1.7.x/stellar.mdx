...
For detailed signer configuration, see the [Signers Configuration](/relayer/1.7.x/configuration/signers) guide.
...
* See [Project Roadmap](/relayer/1.7.x/roadmap) for upcoming features
